...
fun resolveModule(ast: se.rimmer.rc.compiler.parser.Module, handler: ModuleHandler): Module {
...
internal fun prepareImports(module: Module, handler: ModuleHandler, imports: List<se.rimmer.rc.compiler.parser.Import>) {
    imports.forEach {
...
internal fun resolveGlobals(module: Module, decls: List<Decl>) {

}

internal fun resolveFunctions(module: Module, decls: List<Decl>) {
